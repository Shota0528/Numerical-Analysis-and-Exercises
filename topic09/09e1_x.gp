...
plot "09e1_E1.txt" u 1:2 ti "Euler 1st-order" dt 1 lc 4 lw 1 w l,\
     "09e1_RK4.txt" u 1:2 ti "Runge-Kutta 4th-order" dt 3 lc 3 lw 3 w l,\
     cosh(sqrt(2.)*x)+1./sqrt(2.)*sinh(sqrt(2.)*x) ti "true" lc 8
