...
# set output "09e1_err_y.eps" # xxx.epsファイルにグラフを出力
...
plot "09e1_E1.txt" u 1:7 ti "Euler 1st-order" dt 1 lc 4 lw 2 w l,\
     "09e1_RK4.txt" u 1:7 ti "Runge-Kutta 4th-order" dt 3 lc 3 lw 3 w l
